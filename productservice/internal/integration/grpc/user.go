...
func NewUserIntegrationClient(grpcClient *grpc.ClientConn) auth.UserClient {
	return &userClient{
		grpcClient: grpcClient,
	}
}

func (s *userClient) FetchByIDs(ctx context.Context, ids []string) (map[string]auth.Claims, error) {
