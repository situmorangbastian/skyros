...
func (_m *ProductRepository) Fetch(ctx context.Context, filter skyros.Filter) ([]skyros.Product, string, error) {
...
func (_m *ProductRepository) Get(ctx context.Context, ID string) (skyros.Product, error) {
...
func (_m *ProductRepository) Store(ctx context.Context, product skyros.Product) (skyros.Product, error) {
